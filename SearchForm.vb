Public Class SearchForm
    ...
    Protected Sub DisplayFullname(ByVal Fullname)
        Invoke(New FunctionCall(AddressOf _DisplayFullname), Fullname)
    End Sub

    Private Sub _DisplayFullname(ByVal Fullname)
        txtfullname_.Text = Fullname.ToString
    End Sub



    Protected Sub DisplayTime(ByVal Time)
        Invoke(New FunctionCall(AddressOf _DisplayTime), Time)
    End Sub

    Private Sub _DisplayTime(ByVal Time)
        txttime_.Text = Time.ToString
    End Sub
    ...
    Private Sub _DisplayRemark(ByVal Remark)
        txtremark_.Text = Remark.ToString
    End Sub
